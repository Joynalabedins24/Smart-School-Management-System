...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <p>
            Smart solution for managing students, teachers, attendance,
            exams, fees and school activities efficiently.
        </p>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="text-center mb-5">
            ...
            <p class="text-muted">
                Complete digital solution for your institution
            </p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm p-4 text-center feature-card">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm p-4 text-center feature-card">
                    ...
                    <p class="text-muted">
                        Track teachers, schedules and assigned classes.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm p-4 text-center feature-card">
                    <i class="fa-solid fa-calendar-check fa-3x text-danger mb-3"></i>

                    <h4>Attendance System</h4>

                    <p class="text-muted">
                        Digital attendance tracking for students & staff.
                    </p>
                </div>
            </div>
...
<footer class="bg-dark text-white py-3">
    <div class="container text-center">
        ...
        <small class="text-secondary">
            Developed with Laravel & Bootstrap 5
        </small>
    </div>
</footer>
